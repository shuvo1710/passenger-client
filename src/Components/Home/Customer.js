...
const Customer = () => {
    return (
        <div className="px-4 py-16 mx-auto w-full k">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span className="relative inline-block">
              ...
              <span className="relative text-orange-600">Our</span>
            </span>{' '}
            <span className='text-orange-600'>valuable customer</span>
          </h2>
          <p className="text-base text-gray-700 md:text-lg">
          They Are All Expert To Catch Their Extra Cost
          </p>
        </div>

        <div className="grid gap-10 ml-0 lg:ml-40 w-full sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex">
            <img
